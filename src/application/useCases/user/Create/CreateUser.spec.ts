...
describe('CreateUserUseCase', () => {
  ...
  it('should create a new user when user does not exist', async () => {
    ...
    expect(userRepository.getUser).toHaveBeenCalledWith({email: createUserRequestDto.email});
    expect(passwordHasher.hashPassword).toHaveBeenCalledWith(createUserRequestDto.password);
    expect(userRepository.createUser).toHaveBeenCalledWith({ ...createUserRequestDto, password: 'hashedPassword' });
  });
